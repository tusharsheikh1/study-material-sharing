...
const StaffForm = ({ initialData = {}, onSuccess, isEditing = false }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`/staff/${initialData._id}`, formData);
      } else {
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        />
        {uploading && (
          <p className="text-sm text-blue-500 animate-pulse mt-1">
            Uploading image...
          </p>
        )}
        {formData.photoUrl && (
