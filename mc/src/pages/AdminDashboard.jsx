...
const StatCard = ({ icon, title, value, color }) => (
  <div className={`bg-white dark:bg-gray-800 rounded-xl shadow p-4 flex items-center space-x-4 border-t-4 ${color}`}>
    <div className="text-3xl text-gray-800 dark:text-white">{icon}</div>
    <div>
...
const AdminDashboard = () => {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto text-gray-800 dark:text-gray-100">
